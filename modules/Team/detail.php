...
<div class="section">
    <div class="container">
        <div class="row"> 
            <div class="col-md-4">
                <img src='images/article/<?php echo strtolower($_GET["equipe"]) ?>/<?php echo $arrayDetails[0]['file'] ?>'  
                     alt="erreur"
            ...
            <div class="col-md-8"> 
              ...
              <?php if($arrayDetails[0]['size']=="true"){?>
                ...
                <div class="col-xs-2"> 
                    Quantity 
                   <input type= "number" class="form-control" name="quantity" id="formGroupInputSmall" min="1" value="1" >
                 </div>
